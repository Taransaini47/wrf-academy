      ...
      >
        {items.map((item, idx) => (
          <li
            ...
            style={{
              background:
                "linear-gradient(180deg, var(--color-slate-800), var(--color-slate-900))",
            }}
            key={item.name}
          >
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center gap-4">
                {item.image && (
                  <img src={item.image} alt={item.name} className="w-12 h-12 rounded-full border border-slate-600" />
                )}
